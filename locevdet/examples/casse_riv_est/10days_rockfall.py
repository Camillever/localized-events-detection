...
from locevdet.visualisation.plots import plots_comparaison_starts_HIM_FRE
...
plots_comparaison_starts_HIM_FRE(event_list, save_fig_path=save_compare_fig_path, show=False)
