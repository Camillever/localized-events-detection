...
rockfall_catalog_all_mag = False
mainevent = False
rockfall_catalog_average_strong = False
continuous = False
volcanotectonics = False
...
if rockfall_catalog_all_mag :
    # All magnitudes 
    mseeds_all_magnit_path = os.path.join("seismograms", "01-02-2020_11-02-2020", \
        "rockfall", "all_magnitude")
...
if mainevent :
    ...
    mseeds_main_event_path = os.path.join("seismograms", "01-02-2020_11-02-2020", \
        "rockfall", "main_event")
...
if rockfall_catalog_average_strong:
...
if continuous:
    ...
    save_path_continuous_usb = os.path.join("D:","seismograms","01-02-2020_11-02-2020", \
        "continuous")
...
if volcanotectonics:
    ...
    volcanotectonic_events_times = read_events_times_from_csv(csv_sommital_events, \
        time_offset=(35, 65))
    mseeds_volcanotectonic_path = os.path.join("seismograms", "01-02-2020_11-02-2020", \
        "volcanotectonic")
    download_from_stations(
        CLIENT,
        network="PF",
